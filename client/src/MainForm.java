        ...
        calculateButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    ...
                    for (int j = 0; j < 6; j++) {
                        double downLimit = Double.parseDouble(String.valueOf(model.getValueAt(j, 0)));
                        double upLimit = Double.parseDouble(String.valueOf(model.getValueAt(j, 1)));
                        double step = Double.parseDouble(String.valueOf(model.getValueAt(j, 2)));

                        output_.writeDouble(downLimit);
                        output_.writeDouble(upLimit);
                        output_.writeDouble(step);

                        Double result = input_.readDouble();
                        System.out.println(result);

                        model.setValueAt(result, j, 3);
                        list.add(new RecIntegral(downLimit, upLimit, step, result));
                    }
                    client.close();
//                    String nums = "";
//                    for (int i = 0; i < 6; i++){
//                        nums += model.getValueAt(i, 0).toString() + ",";
//                        nums += model.getValueAt(i, 1).toString() + ",";
//                        nums += model.getValueAt(i, 2).toString() + ",";
//                    }
//
...
//                        model.setValueAt(Double.valueOf(res[i]), i, 3);
//                    }
